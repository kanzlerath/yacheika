...
export default function DiscoveryPanel({
  ...
  if (selectedCollection) {
    return (
      <div 
        id="discovery-panel" 
        className="flex flex-col h-full text-zinc-300 bg-[#060608] font-sans"
        style={{
          paddingTop: "calc(4.5rem + env(safe-area-inset-top, 0px))"
        }}
      >
        {/* Header */}
        <div className="p-4 bg-[#060608] border-b border-zinc-900/40 flex items-center gap-3 shrink-0">
          <button
            onClick={() => setSelectedCollection(null)}
            className="flex items-center justify-center bg-zinc-900/60 border border-zinc-850 hover:border-zinc-750 w-9 h-9 rounded-xl text-zinc-300 hover:text-white transition duration-150 cursor-pointer select-none"
        ...
        >
          <div className="p-4 rounded-xl border border-zinc-900 bg-zinc-900/10 space-y-1.5">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-0.5 divide-y divide-zinc-950">
      ...
      <div className="p-4 space-y-3 shrink-0 bg-[#060608] border-b border-zinc-900/40">
        ...
        <div className="flex items-center gap-2">
          {setMobileView && (
            <button
              ...
              className="md:hidden flex items-center justify-center bg-zinc-900/60 border border-zinc-850 hover:border-zinc-750 w-9 h-9 rounded-xl text-zinc-300 hover:text-white transition duration-150 cursor-pointer select-none shrink-0"
              title="Назад к карте"
            >
              <ArrowLeft className="w-4 h-4" />
            </button>
        ...
        <div className="flex items-start gap-2">
          <div className="flex-1 min-w-0">
            {isFiltersExpanded ? (
              <div className="flex flex-wrap gap-1.5 py-0.5 animate-fadeIn">
                    ...
                    <button
                      ...
                      className={`text-[11px] px-3.5 py-1.5 rounded-lg font-medium transition select-none cursor-pointer duration-150 ${
                        active
                          ...
                          : "bg-zinc-900/35 text-zinc-400 border border-zinc-900 hover:border-zinc-850 hover:text-zinc-200"
                      }`}
                    >
                      {pill.label}
                    </button>
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 rounded-lg bg-zinc-900/50 border border-zinc-900 hover:border-zinc-800 text-zinc-400 hover:text-white transition shrink-0 cursor-pointer"
